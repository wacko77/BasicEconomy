...
public class PVUtils {
    public static void storeItems(List<ItemStack> items, Player p){
        ...
        if (items.size() == 0){
            ...
            try {
                ...
                data.set(new NamespacedKey(BasicEconomy.getPlugin(), "pv"), PersistentDataType.STRING, encodedData);
    ...
    public static ArrayList<ItemStack> getItems(Player p){
        ...
        String encodedItems = data.get(new NamespacedKey(BasicEconomy.getPlugin(), "pv"), PersistentDataType.STRING);
